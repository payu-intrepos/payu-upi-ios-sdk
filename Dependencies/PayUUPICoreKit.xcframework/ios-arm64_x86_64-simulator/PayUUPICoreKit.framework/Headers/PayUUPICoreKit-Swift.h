...
+ (NSDictionary<NSString *, id> * _Nonnull)getMandatoryParamsForUnderscorePaymentFromParams:(PayUPaymentParam * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, id> * _Nonnull)getMandatoryTPVParamsForUnderscorePaymentFromParams:(PayUPaymentParam * _Nonnull)params SWIFT_WARN_UNUSED_RESULT;
